...
#ifndef CIRCT_CONVERSION_COMBTOLAKEROAD_COMBTOLAKEROAD_H
#define CIRCT_CONVERSION_COMBTOLAKEROAD_COMBTOLAKEROAD_H
...
std::unique_ptr<mlir::Pass> createCombToLakeroadPass();

} // namespace circt

#endif // CIRCT_CONVERSION_COMBTOLAKEROAD_COMBTOLAKEROAD_H
